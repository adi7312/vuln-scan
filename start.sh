...
docker run --detach --publish 8090:9392 -e SKIPSYNC=true -e IP=$IP -e FREQUENCY=$FREQUENCY -e EMAIL=$EMAIL -e USERNAME=admin -e PASSWORD=admin --name avs ghcr.io/adi7312/vuln-scan:latest
